...
class FlxUIInputText extends FlxSpriteGroup
{
	...
	public static var focusOn(default, set):FlxUIInputText = null;
		...
		if(e.controlKey)
		{
			switch(flxKey)
			{
				...
				case V: //paste from clipboard
					...
					if(broadcastInputTextEvent) FlxUIEventHandler.event(CHANGE_EVENT, this);
	...
	public static function set_focusOn(v:FlxUIInputText)
	{
