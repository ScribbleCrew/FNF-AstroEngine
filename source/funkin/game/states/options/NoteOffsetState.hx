...
{
	var boyfriend:funkin.game.objects.characters.Character;
	var gf:funkin.game.objects.characters.Character;
	...
	var timeBar:FlxBar;
	var timeTxt:FlxText;
	var beatText:funkin.game.objects.Alphabet;
	...
	override public function create()
	{
		...
		Windows.title = ('%{GAME_TITLE} - Options - Note Offsets');
		#end
		...
		beatText = new funkin.game.objects.Alphabet(0, 0, 'Beat Hit!', true);
		beatText.scaleX = 0.6;
		beatText.scaleY = 0.6;
		beatText.x += 260;
		beatText.alpha = 0;
		...
		timeTxt.setFormat(Constants.DEFAULT_FONT, 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		changeModeText.setFormat(Constants.DEFAULT_FONT, 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Constants.DEFAULT_FONT, 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
