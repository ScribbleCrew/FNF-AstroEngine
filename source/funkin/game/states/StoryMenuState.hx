...
import funkin.game.states.substates.ResetScoreSubState;
...
class StoryMenuState extends MusicBeatState
{
	...
	var leftArrow:CampaignUI;
	var rightArrow:CampaignUI;
	...
	override function create()
	{
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			if (!isLocked || !weekFile.hiddenUntilUnlocked)
			{
				...
				if (isLocked)
				{
					var lock:CampaignUI = new CampaignUI(weekThing.width + 10 + weekThing.x, "lock");
		...
		leftArrow = new CampaignUI(850, grpWeekText.members[0].y + 10, "left");
		leftArrow.bind('clicked', (obj:CampaignUI) -> changeDifficulty(-1));
		difficultySelectors.add(leftArrow);

		rightArrow = new CampaignUI(leftArrow.x + 376, leftArrow.y, "right");
		rightArrow.bind('clicked', (obj:CampaignUI) -> changeDifficulty(1));
