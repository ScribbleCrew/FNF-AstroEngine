...
class StoryMenuState extends MusicBeatState
{
	...
	var finishedCheckingState:Bool = false;
	...
	override function create()
	{
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07 + 100, bgSprite.y + 425).loadGraphic(Paths.image('storymenu/props/Menu_Tracks'));
