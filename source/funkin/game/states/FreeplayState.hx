...
class FreeplayState extends MusicBeatState
{
	...
	{
		songs.push(new SongMeta(songName, weekNum, songCharacter, color));
	}
	...
	function weekIsLocked(name:String):Bool
	{
		...
		return (!leWeek.startUnlocked
			...
			&& (!Week.weekCompleted.exists(leWeek.weekBefore) || !Week.weekCompleted.get(leWeek.weekBefore)));
	}
	...
	override function update(elapsed:Float)
	{
		...
		var ratingSplit:Array<String> = Std.string(MathsAddon.floorDecimal(lerpRating * 100, 2)).split('.');
