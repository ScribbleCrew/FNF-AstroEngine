...
class FlxDebugger extends Sprite
{
	...
	public var boykisser:BoyKisser;
	...
	**/
	...
	function new(Width:Float, Height:Float)
	{
		...
		addWindow(boykisser = new BoyKisser());
		...
		addWindowToggleButton(boykisser, GraphicWatch);
	...
	public function resetLayout():Void
	{
		switch (_layout)
		{
			case MICRO:
				...
				boykisser.reposition(_screen.x - boykisser.width - GUTTER, _screen.y - boykisser.height - GUTTER);
			case BIG:
			...
			case TOP:
				...
				boykisser.reposition(_screen.x, _screen.y - boykisser.height - GUTTER);
			case LEFT:
				console.resize(_screen.x - GUTTER * 2, 35);
				console.reposition(GUTTER, _screen.y);
		...
		boykisser.resize(boykisser.width, boykisser.height);
	}
